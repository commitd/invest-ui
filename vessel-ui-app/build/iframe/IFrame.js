...
var IFrame = (function (_super) {
    ...
    IFrame.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "fullsize-iframe-container" },
            React.createElement("iframe", { key: src, title: "View", sandbox: "allow-scripts", src: src, ref: function (e) {
                    if (e != null) {
                        // TODO: is e changed?
                        _this.ref = e;
                    }
